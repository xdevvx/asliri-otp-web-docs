# ASLIRI OTP WEB
OTP by ASLIRI for your web apps. You can screening your client with OTP.
...
Please save the **template** to your database because it will be used for verification data.
...
## How do I integrate ASLIRI OTP Web ?
### REGISTER
#### 1. Hit the API to register
